...
*/
    ...
    {RIL_UNSOL_ENTER_LPM, NULL, WAKE_PARTIAL},                                    // s_unsolResponses[49]: 1523
    {RIL_UNSOL_CDMA_3G_INDICATOR, NULL, WAKE_PARTIAL},                            // s_unsolResponses[50]: 3009 (s4) / 4259 (m7)
    {RIL_UNSOL_CDMA_ENHANCE_ROAMING_INDICATOR, NULL, WAKE_PARTIAL},        // s_unsolResponses[51]: 3012
    {RIL_UNSOL_CDMA_NETWORK_BASE_PLUSCODE_DIAL, NULL, WAKE_PARTIAL},           // s_unsolResponses[52]: 3020
    {RIL_UNSOL_RESPONSE_PHONE_MODE_CHANGE, NULL, WAKE_PARTIAL},                   // s_unsolResponses[53]: 6002 (s4) / 4802 (m7)
    {RIL_UNSOL_RESPONSE_VOICE_RADIO_TECH_CHANGED, NULL, WAKE_PARTIAL},            // s_unsolResponses[54]: 21004
    {RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED_HTC, NULL, WAKE_PARTIAL},       // s_unsolResponses[55]: 21005
    {RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED, NULL, WAKE_PARTIAL},  // s_unsolResponses[56]: 21007 (s4) / 5757 (m7)
    {RIL_UNSOL_SECTOR_ID_IND, NULL, WAKE_PARTIAL},                              // s_unsolResponses[57]: 3057 (m7)
    {RIL_UNSOL_TPMR_ID, NULL, WAKE_PARTIAL},                                      // s_unsolResponses[58]: 3024 (m7)
