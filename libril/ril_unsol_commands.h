...
*/
    ...
    {RIL_UNSOL_ENTER_LPM_M7, /* responseVoid */ NULL, WAKE_PARTIAL},                                  // s_unsolResponses: 3023
    {RIL_UNSOL_CDMA_3G_INDICATOR_M7, /* responseInts */ NULL, WAKE_PARTIAL},                          // s_unsolResponses: 4259 
    {RIL_UNSOL_CDMA_ENHANCE_ROAMING_INDICATOR_M7, /* responseCdmaERIInfo */ NULL, WAKE_PARTIAL},      // s_unsolResponses: 4262
    {RIL_UNSOL_CDMA_NETWORK_BASE_PLUSCODE_DIAL_M7, /* responseString */ NULL, WAKE_PARTIAL},          // s_unsolResponses: 4270
    {RIL_UNSOL_RESPONSE_PHONE_MODE_CHANGE_M7, /* responseInts */ NULL, WAKE_PARTIAL},                 // s_unsolResponses: 4802
    {RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED_M7, /* responseDataCallList */ NULL, WAKE_PARTIAL},// s_unsolResponses: 5757
    {RIL_UNSOL_SECTOR_ID_IND, /* responseString */ NULL, WAKE_PARTIAL},                               // s_unsolResponses: 3057
    {RIL_UNSOL_TPMR_ID, /* responseInts */ NULL, WAKE_PARTIAL},                                       // s_unsolResponses: 3024
